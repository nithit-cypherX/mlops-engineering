...
Rates are THB per hour, on-demand. SPOT_FACTOR is an inherited rough estimate, not a
verified discount. Our Dedicated compute uses spot=False.
"""
from __future__ import annotations

# Copied from the instructor's src/costs.py at
# 30ba98b02e8f233c7d7a36d584738ea442e46bd1; functions are unchanged.
# Only Standard_F2s_v2 below has been verified for this lab. Other rates remain
# instructor starting values, not verified prices for our region.
# TODO(Lab 2): record the price check in reports/lab2-comparison.md with Task 3.
PRICE_TABLE: dict[str, dict[str, float]] = {
    ...
    "azure": {
        # Checked 2026-09-18: Linux, Dedicated/on-demand, Malaysia West (malaysiawest).
        # Source: https://prices.azure.com/api/retail/prices (2023-01-01-preview).
        # Filter: armRegionName=malaysiawest, armSkuName=Standard_F2s_v2,
        # priceType=Consumption; productName="Virtual Machines FSv2 Series",
        # skuName="F2s v2", unitOfMeasure="1 Hour", isPrimaryMeterRegion=true.
        # USD 0.0882/hour; THB 2.900677/hour is Microsoft's budget reference,
        # not an invoice FX rate or total bill. Excludes storage and other services.
        "Standard_F2s_v2": 2.900677,
        "Standard_DS3_v2": 8.1,
        "Standard_F4s_v2": 6.9,
