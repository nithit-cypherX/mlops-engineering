...
Provider-neutral operations for the course labs. Lab 3 adds explicit model loading
so the service loads a registered version through the same adapter boundary.
...
class CloudAdapter(ABC):
    ...
    def load_model(self, name: str, version: str) -> Any:
        """Load one registered version, once per service process at startup."""
        raise NotImplementedError("Lab 3: registry model loading")
